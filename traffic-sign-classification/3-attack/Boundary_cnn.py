...
DATADIR_TEST = os.path.dirname(os.path.split(os.getcwd())[0]) + r"/Final_Data/Test2"
...
save(r'./Generated Adversarial Data/boundary_cnn_adv.npy', x_test_adv)


advPredictions = classifier.predict(x_test_adv)
print('advPredictions', advPredictions)
print('y_test', y_test)
