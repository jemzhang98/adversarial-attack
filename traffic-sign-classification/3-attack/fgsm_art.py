...
# import StnCnn class
CNNFOLDER = os.path.dirname(os.path.split(os.getcwd())[0]) + r"/traffic-sign-classification1/task2"
...
DATADIR = os.path.dirname(os.path.split(os.getcwd())[0]) + r"/traffic-sign-classification1/task2/Final_Data/Train"
DATADIR_TEST = os.path.dirname(os.path.split(os.getcwd())[0]) + r"/traffic-sign-classification1/task2/Final_Data/Test"
...
#                 r'/traffic-sign-classification1/task2/lightning_logs/version_1/checkpoints/epoch=22.ckpt'
checkpointLoc = os.path.dirname(os.path.split(os.getcwd())[0]) + r'/traffic-sign-classification1/task2/lightning_logs/version_1/checkpoints/epoch=22.ckpt'
