...
DATADIR_TEST = r'C:\Users\jungc\Desktop\Test_Images_Color\Test_Images_Color'
...
tmplist = ['i2', 'i4', 'i5', 'io', 'ip', 'p11', 'p23', 'p26', 'p5', 'pl30',
              'pl40', 'pl5', 'pl50', 'pl60', 'pl80', 'pn', 'pne', 'po', 'w57']
asd = []
for lol in acc:
    asd.append(tmplist[lol])
...
path = DATADIR_TEST
count = 0
root = r'C:\Users\jungc\Desktop\Test_Images_Color\Test_Images_Color'
for dir, subdirs, files in os.walk(root):
    for f in files:
        f_new = str(count) + '_' + asd[count] + '.png'
