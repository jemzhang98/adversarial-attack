...
filename = 'Models/sklearn_cifar10_model.sav'
...
if os.path.isfile('./' + filename):
    ...
    classifier.fit(x_train_g, y_train)
...
attack = SquareAttack(estimator=classifier, eps=0.2, max_iter=2000)
x_test_adv = attack.generate(x=x_test)

# define data
# save to npy file
print('Saving generated adv data')
save('cifar10_square_adv.npy', x_test_adv)
